...
public class UserAgent : PuppeteerExtraPlugin
{
    ...
    public override async Task OnPageCreated(IPage page)
    {
        ...
        var platform = this.GetPlatform(ua);
        var brand = this.GetBrands(uaVersion);

        var isMobile = this.GetIsMobile(ua);
        var platformVersion = this.GetPlatformVersion(ua);
        var platformArch = this.GetPlatformArch(isMobile);
        var platformModel = this.GetPlatformModel(isMobile, ua);
